  ...
  return (
    <section className="border-t border-white/10 py-16" suppressHydrationWarning>
      <div className="mx-auto max-w-7xl px-6" suppressHydrationWarning>
        <div className="flex flex-col gap-3 text-center mb-20" style={{ position: "relative", zIndex: 50 }}>
        ...
        <div
          ...
          style={{ minWidth: "320px", height: "700px", minHeight: "700px", width: "100%", marginTop: "2rem", position: "relative", zIndex: 1 }}
